...
File argument
```
kali@kali ~> ttc -f tickethere.txt
...
- Converting Cacche To Ticket
- Possible rework? replacing os.system
  - using impacket code to describe ticket
  - using impacket code to convert ticket
